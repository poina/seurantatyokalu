...
//$sql="select * from sisalto WHERE sulkeutuu < CURDATE() order by hinta DESC";
//$sql="select * from sisalto WHERE sulkeutuu < CURDATE() ORDER BY CAST(SUBSTRING(hinta,LOCATE(' ',hinta)+1) AS SIGNED) DESC";
$sql="select * from sisalto WHERE sulkeutuu < CURDATE() order by CAST(hinta AS SIGNED) DESC";
