...
<!-- filtteri alkaa tästä -->
	...
	<div id="filtteri">
		<table>
			<tr>
				...
				<!-- pvm  -->
				<td>
					<form name="valinta" action="ettusivuhistoria.php" method="post">
	...
	<?php
				...
				if($jarjestys=='1')
				{
					include('luehistoria.php');
				}
				if($jarjestys=='2')
				{
					include('luehistoria2.php');
				}
				if($jarjestys=='3')
				{
					include('historiasuodata1.php');
				}
				if($jarjestys=='4')
				{
					include('historiasuodata2.php');
				}
				if($jarjestys=='5')
				{
					include('historiasuodata3.php');
				}
				if($jarjestys=='6')
				{
					include('historiasuodata4.php');
				}
				if($jarjestys=='7')
				{
					include('historiasuodata5.php');
				}
				if($jarjestys=='8')
				{
					include('historiasuodata6.php');
				}				
				/*else
				{
					include('luehistoria.php');
